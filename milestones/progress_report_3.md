...
- User (table + profile APIT)
- Trips (table + CRUD API + budget filter)
- Destinations (table + CRUD API, nested under trip)
- Activities(table + CRUD API, nested under trip)
- Expenses (table + CRUD API + spending summary)
